-- Enhanced Analytics and Long-term Persona System
-- This migration adds periodic summaries, long-term persona tracking, and automated analytics
...
-- Note: Cron jobs are created without existence checks as they're typically managed separately

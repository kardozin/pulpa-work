...
-- Nota: Los cron jobs se configuran por separado para evitar errores de sintaxis

-- Resúmenes semanales: cada lunes a las 02:00 UTC
...
-- Resúmenes mensuales: primer día de cada mes a las 03:00 UTC
SELECT cron.schedule(
